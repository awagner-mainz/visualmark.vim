...
" DrChip menu support (added by Andreas Wagner on 20040608): - - - -
if has("gui_running") && has("menu")
  if !exists("g:DrChipTopLvlMenu")
"  let g:DrChipTopLvlMenu= "DrChip."
    let g:DrChipTopLvlMenu= "Plugin."
  endif
  exe 'menu '.g:DrChipTopLvlMenu.'Bookmarks.Toggle<tab><c-F2> Vm_toggle_sign'
  exe 'menu '.g:DrChipTopLvlMenu.'Bookmarks.GotoNext<tab><F2> Vm_goto_next_sign'
  exe 'menu '.g:DrChipTopLvlMenu.'Bookmarks.GotoPrev<tab><s-F2> Vm_goto_prev_sign'
endif
...
if has("unix")
	...
	if &bg == "dark"
 		highlight SignColor ctermfg=white ctermbg=blue guifg=white guibg=DarkBlue
	else
 		highlight SignColor ctermbg=white ctermfg=blue guibg=grey guifg=DarkBlue
	endif
endif
